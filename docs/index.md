...
The project benchmarks a lightweight Convolutional Neural Network, **MobileNetV2**, against a Vision Transformer, **DINOv2 (ViT-S/14)**. The system includes a FastAPI + React web application for dual-model inference and prediction comparison.
